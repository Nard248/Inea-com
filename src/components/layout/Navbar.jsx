...
const Navbar = () => {
  ...
  // Flat navigation. "Tools" was previously a dropdown wrapping Calculators +
  // Pricing; it is now a direct "Calculators" link (Pricing lives in the footer)
  // to keep the bar from overflowing with the longer Armenian labels.
  const navLinks = [
    { to: '/', label: t('nav.home') },
